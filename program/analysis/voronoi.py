...
class DelaunayBase:
    ...
    def windingNumber2(self, xyt: ut.CArray, angles: ut.CArray) -> np.ndarray:
        s2 = ut.CArray(np.zeros((self.num_rods,), dtype=np.int32))
        ker.dll.windingNumber2(*self.params, xyt.ptr, angles.ptr, s2.ptr)
        return s2.data
