...
def InitRecipe():
    SetRelaxationRecipe(
        Relaxation(noise_factor=0, momentum_beta=0, stochastic_p=0.1, inertia=1, stepsize=1e-4, relaxation_steps=1e4,
        ...
        Relaxation(noise_factor=0, momentum_beta=0, stochastic_p=1, inertia=1, stepsize=0.1, relaxation_steps=1e4,
                   state_pool_stride=1, auto_stepsize=True, enable_lbfgs=True, record_descent=True,
