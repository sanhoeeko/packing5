...
def InitRecipe():
    SetRelaxationRecipe(
        Relaxation(noise_factor=0, momentum_beta=0, stochastic_p=1, inertia=1, stepsize=1e-4, relaxation_steps=2e4,
        ...
        Relaxation(noise_factor=0, momentum_beta=0, stochastic_p=1, inertia=1, stepsize=1, relaxation_steps=2e4,
                   state_pool_stride=1, auto_stepsize=StepsizeHelper.Good, enable_lbfgs=False, record_descent=True,
